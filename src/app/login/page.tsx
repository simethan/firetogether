...
function AuthForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (isSignUp) {
      // After sign-up, Supabase may require email confirmation depending
      // on dashboard settings. If auto-confirm is ON, the user is
      // signed in immediately and we redirect. If OFF, we show a message.
    ...
    <div className="flex min-h-full flex-col items-center justify-center px-4 py-12">
      ...
      <Card className="w-full max-w-sm">
        ...
        <CardContent className="space-y-5 pt-2">
          ...
          {success && (
            <div className="rounded-lg border border-green-500/20 bg-green-500/10 p-3 text-center text-sm text-green-700 dark:text-green-400">
              {success}
            </div>
          )}
